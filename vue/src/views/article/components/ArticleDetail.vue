...
import Sticky from '@/components/Sticky'  import { getArticle, postArticle } from '@/api/article'
...
const defaultForm = {
  title: '',    description: '',    content: '',    contentMd: '',    categoryId: 1,    image: undefined,    url: undefined,    type: 0,
  tags: [],
  id: undefined,
  isOriginal: true,
  sourceUrl: undefined,
